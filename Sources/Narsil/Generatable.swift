...
public struct CityName: Generatable {
    public var patterns: [String] = []
    public var patternFileName: String = "cityname"
    public var capitalisation = CapitalisationType.word
    public init(){}
}
...
public struct DungeonLevelName: Generatable {
    public var patterns: [String] = []
    public var patternFileName: String = "dungeonlevelname"
    public var capitalisation = CapitalisationType.word
    public init(){}
}

public struct CorporationName: Generatable {
    public var patterns: [String] = []
    public var patternFileName: String = "corporation"
    public var capitalisation = CapitalisationType.word
    public init(){}
}

public struct InstallationName: Generatable {
    public var patterns: [String] = []
    public var patternFileName: String = "installation"
    public var capitalisation = CapitalisationType.word
    public init(){}
}
...
public struct MagicalTreasureOracle: Generatable {
    public var patterns: [String] = []
    public var patternFileName: String = "magicaltreasure"
    public var capitalisation = CapitalisationType.initial
    public init(){}
}
